"""
Django settings for penguinhlx project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'www.penguinhlx.club', '120.78.213.145','penguinhlx.club']
...
WSGI_APPLICATION = 'penguinhlx.wsgi.application'
